...
public class SimpleCalculator {
    private double firstNumber;                 // private variable assigned
    private double secondNumber;                // private variable assigned
    ...
    public static void main(String[] args) {                    // main method declared
        SimpleCalculator calculator = new SimpleCalculator();   // new keyword use to call from

        calculator.setFirstNumber(5.0);                         // value given
