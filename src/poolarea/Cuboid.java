 ...
 */
public class Cuboid extends Rectangel {   // extending from parent class ractangle
    private double height;   //

    public Cuboid(double width, double length, double height) {  // public method with double variables
        super(width, length);
