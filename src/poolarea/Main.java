...
public class Main {
    public static void main(String[] args) {                                // main method
        Rectangel rectangel = new Rectangel(5, 10);             // assigning given value
        System.out.println("rectangle.width = " + rectangel.getWidth());    // print statement
        System.out.println("rectangle.length =" + rectangel.getLength());   // print statement
        System.out.println("rectangle.area =" + rectangel.getArea());       // print statement

        Cuboid cuboid = new Cuboid(5, 10,5);          // variable value define
        System.out.println("cuboid.width =" + cuboid.getWidth());       // print statement from ractangle class
        System.out.println("cuboid.length =" + cuboid.getLength());     // print statement from ractangle class
        System.out.println("cuboid.area =" + cuboid.getArea());         // print statement from ractangle class
        System.out.println("cuboid.height =" + cuboid.getHeight());     // print statement from cuboid class
        System.out.println("cuboid.volume =" + cuboid.getVolume());     // print statement from cuboid class
    }
}
